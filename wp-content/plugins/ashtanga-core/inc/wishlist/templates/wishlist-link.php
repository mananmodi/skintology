...
<div class="qodef-wishlist qodef-m">
	<a class="qodef-m-link <?php echo esc_attr( $wishlist_class ); ?>" href="#" data-id="<?php the_ID(); ?>">
		<?php
		if ( $enable_title ) {
			$wishlist_title       = esc_html__( 'Add to wishlist', 'ashtanga-core' );
			$wishlist_added_title = esc_html__( 'Added into wishlist', 'ashtanga-core' );
			?>
		...
		<?php } ?>
		<?php echo ashtanga_core_get_svg_icon( 'heart' ); ?>
	</a>
