...
if ( $has_image ) {
	...
	?>
	<div class="qodef-e-media-video qodef-e-image-video">
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php echo ashtanga_core_get_list_shortcode_item_image( $image_dimension, $blog_list_image, $custom_image_width, $custom_image_height ); ?>
