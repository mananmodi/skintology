...
if ( ! function_exists( 'ashtanga_core_add_side_area_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function ashtanga_core_add_side_area_mobile_header_options( $page, $general_tab ) {
	...
	add_action( 'ashtanga_core_action_after_mobile_header_options_map', 'ashtanga_core_add_side_area_mobile_header_options', 10, 2 );
}
