...
if ( ! class_exists( 'AshtangaCore_Custom_Post_Types' ) ) {
	class AshtangaCore_Custom_Post_Types {
		...
		/**
		 * @return AshtangaCore_Custom_Post_Types
		 */
		...
		function init() {
			...
			include_once ASHTANGA_CORE_CPT_PATH . '/dashboard/customizer/post-types-customizer-options.php';
		}
		...
		function set_enabled_post_types() {
			...
			do_action( 'ashtanga_core_action_add_custom_post_type', $this );
		}
		...
		function register_post_types() {
			...
			$cpts           = apply_filters( 'ashtanga_core_filter_register_custom_post_types', array() );
		...
		function include_taxonomies() {
			// Hook to include custom post types taxonomy fields
			do_action( 'ashtanga_core_action_include_cpt_tax_fields' );
		}

		function register_taxonomies() {
			// Hook to include custom post types taxonomy fields
			do_action( 'ashtanga_core_action_register_cpt_tax_fields' );
		}
	...
	AshtangaCore_Custom_Post_Types::get_instance();
}
