...
if ( ! function_exists( 'ashtanga_core_add_team_title_options' ) ) {
	/**
	 * Function that add title options for team module
	 */
	function ashtanga_core_add_team_title_options( $tab ) {
	...
	add_action( 'ashtanga_core_action_after_team_options_single', 'ashtanga_core_add_team_title_options' );
}
