...
class AshtangaCore_Top_Area {
	...
	public function __construct() {
		...
		add_action( 'ashtanga_action_before_page_header', array( $this, 'load_template' ) );
		...
		add_filter( 'ashtanga_filter_add_inline_style', array( $this, 'set_inline_top_area_styles' ) );
		add_filter( 'ashtanga_core_filter_top_area_inner_class', array( $this, 'set_grid_class' ) );
	}

	/**
	 * @return AshtangaCore_Top_Area
	 */
	...
	function is_top_area_enabled() {
		$top_area_enabled = 'yes' === ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header' );
		$header_layout    = ashtanga_core_get_post_value_through_levels( 'qodef_header_layout' );
	...
	public function set_top_area_height() {
		if ( $this->is_top_area_enabled ) {
			$height         = ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
	...
	public function is_top_area_transparent() {
		$background_color = ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header_background_color' );
	...
	public function load_template() {
		...
		ashtanga_core_template_part( 'header/top-area/', 'templates/top-area', '', $parameters );
	}
	...
	public function set_inline_top_area_styles( $style ) {
		...
		$height       = ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
		$side_padding = ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header_side_padding' );
		$border_color = ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header_border_color' );
		$border_width = ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header_border_width' );
		$border_style = ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header_border_style' );
	...
	public function set_grid_class( $classes ) {
		if ( 'yes' === ashtanga_core_get_post_value_through_levels( 'qodef_top_area_header_in_grid' ) ) {
...
AshtangaCore_Top_Area::get_instance();
