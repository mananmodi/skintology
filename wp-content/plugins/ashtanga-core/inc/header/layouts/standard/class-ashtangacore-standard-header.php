...
class AshtangaCore_Standard_Header extends AshtangaCore_Header {
	...
	/**
	 * @return AshtangaCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return ashtanga_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
