...
if ( ! function_exists( 'ashtanga_core_add_divided_header_options' ) ) {
	/**
	 ...
	 */
	function ashtanga_core_add_divided_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'       => 'qodef_divided_header_section',
				'title'      => esc_html__( 'Divided Header', 'ashtanga-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'ashtanga_core_action_after_header_options_map', 'ashtanga_core_add_divided_header_options', 10, 2 );
}
