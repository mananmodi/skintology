...
if ( ! function_exists( 'ashtanga_core_add_divided_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function ashtanga_core_add_divided_header_meta( $page ) {
	...
	add_action( 'ashtanga_core_action_after_page_header_meta_map', 'ashtanga_core_add_divided_header_meta' );
}
