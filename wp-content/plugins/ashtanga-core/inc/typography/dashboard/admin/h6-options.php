...
if ( ! function_exists( 'ashtanga_core_add_h6_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function ashtanga_core_add_h6_typography_options( $page ) {
		...
		if ( $page ) {
			$h6_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h6',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H6 Typography', 'ashtanga-core' ),
					'description' => esc_html__( 'Set values for Heading 6 HTML element', 'ashtanga-core' ),
				)
			);
	...
	add_action( 'ashtanga_core_action_after_typography_options_map', 'ashtanga_core_add_h6_typography_options' );
}
