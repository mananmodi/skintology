...
class AshtangaCore_Covers_Header_Search extends AshtangaCore_Search {
	...
	/**
	 * @return AshtangaCore_Covers_Header_Search
	 */
	...
	public function load_template() {
		if ( is_active_widget( false, false, 'ashtanga_core_search_opener' ) ) {
			...
			$actions         = array();
			$sidebars        = qode_framework_get_widget_sidebars( 'ashtanga_core_search_opener' );
			...
			foreach ( $sidebars as $sidebar ) {
				if ( 'qodef-header-widget-area-one' === $sidebar || 'qodef-header-widget-area-two' === $sidebar ) {
					$actions[] = 'ashtanga_action_after_page_header_inner';
					$actions[] = 'ashtanga_core_action_after_sticky_header';
				} elseif ( 'qodef-mobile-header-widget-area' === $sidebar ) {
					$actions[] = 'ashtanga_action_after_page_mobile_header_inner';
					$actions[] = 'ashtanga_core_action_after_page_mobile_header_inner';
				} elseif ( 'qodef-top-area-left' === $sidebar || 'qodef-top-area-right' === $sidebar ) {
					$actions[] = 'ashtanga_core_action_after_top_area';
