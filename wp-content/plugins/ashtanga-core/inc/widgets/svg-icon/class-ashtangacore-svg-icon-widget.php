...
if ( ! function_exists( 'ashtanga_core_add_svg_icon_widget' ) ) {
	/**
	 ...
	 * @return array
	 */
	function ashtanga_core_add_svg_icon_widget( $widgets ) {
		$widgets[] = 'AshtangaCore_Svg_Icon_Widget';

		return $widgets;
	}

	add_filter( 'ashtanga_core_filter_register_widgets', 'ashtanga_core_add_svg_icon_widget' );
}

if ( class_exists( 'QodeFrameworkWidget' ) ) {
	class AshtangaCore_Svg_Icon_Widget extends QodeFrameworkWidget {

		public function map_widget() {
			$this->set_base( 'ashtanga_core_svg_icon' );
			$this->set_name( esc_html__( 'Ashtanga Icon Svg', 'ashtanga-core' ) );
			$this->set_description( esc_html__( 'Add a icon svg element into widget areas', 'ashtanga-core' ) );
			$this->set_widget_option(
				array(
					'field_type' => 'textarea',
					'name'       => 'icon',
					'title'      => esc_html__( 'Icon Svg Code', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
			...
			$this->set_widget_option(
				array(
					'field_type'  => 'text',
					'name'        => 'icon_margin',
					'title'       => esc_html__( 'Icon Margin', 'ashtanga-core' ),
			...
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Icon Holder Width (px)', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Icon Holder Height (px)', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Icon Stroke Color', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Icon Stroke Hover Color', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Icon Fill Color', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Icon Fill Hover Color', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Icon Background Color', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Icon Background Hover Color', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
					...
					'title'       => esc_html__( 'Icon Border Radius', 'ashtanga-core' ),
					'description' => esc_html__( 'Insert border radius in format: top right bottom left', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
			...
			$this->set_widget_option(
				array(
					...
					'title'      => esc_html__( 'Space Between Icon and Text (px)', 'ashtanga-core' ),
				)
			);
			$this->set_widget_option(
				array(
