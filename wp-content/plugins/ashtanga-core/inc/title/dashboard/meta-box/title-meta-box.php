...
if ( ! function_exists( 'ashtanga_core_add_page_title_meta_box' ) ) {
	/**
	 * Function that add general meta box options for this module
	 *
	 * @param object $page
	 */
	function ashtanga_core_add_page_title_meta_box( $page ) {
		...
		if ( $page ) {
			...
			$title_tab = $page->add_tab_element(
				array(
					...
					'description' => esc_html__( 'Title layout settings', 'ashtanga-core' ),
				)
			);
			...
			$page_title_section->add_field_element(
				array(
					...
					'options'     => apply_filters( 'ashtanga_core_filter_title_layout_options', array( '' => esc_html__( 'Default', 'ashtanga-core' ) ) ),
				)
			);
			...
			do_action( 'ashtanga_core_action_after_page_title_meta_box_map', $page_title_section );
		}
	}

	add_action( 'ashtanga_core_action_after_general_meta_box_map', 'ashtanga_core_add_page_title_meta_box' );
}

if ( ! function_exists( 'ashtanga_core_add_general_page_title_meta_box_callback' ) ) {
	/**
	 ...
	 * @return array
	 */
	function ashtanga_core_add_general_page_title_meta_box_callback( $callbacks ) {
		$callbacks['page-title'] = 'ashtanga_core_add_page_title_meta_box';

		return $callbacks;
	}

	add_filter( 'ashtanga_core_filter_general_meta_box_callbacks', 'ashtanga_core_add_general_page_title_meta_box_callback' );
}
