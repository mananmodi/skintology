...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image">
		<?php if ( function_exists( 'woocommerce_template_loop_product_link_open' ) ) { woocommerce_template_loop_product_link_open(); } ?>
			<?php ashtanga_core_template_part( 'plugins/woocommerce/shortcodes/product-list', 'templates/post-info/mark' ); ?>
			<?php echo ashtanga_core_get_list_shortcode_item_image( $image_dimension, $product_list_image, $custom_image_width, $custom_image_height ); ?>
		<?php if ( function_exists( 'woocommerce_template_loop_product_link_close' ) ) { woocommerce_template_loop_product_link_close(); } ?>
	</div>
<?php } ?>