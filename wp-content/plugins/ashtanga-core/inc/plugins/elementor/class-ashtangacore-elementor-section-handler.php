...
class AshtangaCore_Elementor_Section_Handler {
	...
	public function __construct() {
		...
		// column extension
		add_action( 'elementor/element/column/_section_responsive/after_section_end', array(
			$this,
			'render_background_text_options'
		), 10, 2 );
	...
	/**
	 * @return AshtangaCore_Elementor_Section_Handler
	 */
	...
	public function render_background_text_options( $column, $args ) {
		$column->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Ashtanga Core Background Text', 'ashtanga-core' ),
				'tab'   => \Elementor\Controls_Manager::TAB_ADVANCED,
			)
		);
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Enable Background Text', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'no',
				'options'     => array(
					'no'  => esc_html__( 'No', 'ashtanga-core' ),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Color', 'ashtanga-core' ),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size (px)', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - between 1440 and 1367 (px)', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - between 1366 and 1025 (px)', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - below 1024 (px)', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset (px)', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - between 1440 and 1367 (px)', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - between 1366 and 1025 (px)', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - below 1024 (px)', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Horizontal Align', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'flex-start',
				'options'     => array(
					'flex-start' => esc_html__( 'Left', 'ashtanga-core' ),
					'center'     => esc_html__( 'Center', 'ashtanga-core' ),
					'flex-end'   => esc_html__( 'Right', 'ashtanga-core' ),
				),
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Align', 'ashtanga-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'flex-start',
				'options'     => array(
					'flex-start' => esc_html__( 'Top', 'ashtanga-core' ),
					'center'     => esc_html__( 'Middle', 'ashtanga-core' ),
...
if ( ! function_exists( 'ashtanga_core_init_elementor_section_handler' ) ) {
	/**
	 * Function that initialize main page builder handler
	 */
	function ashtanga_core_init_elementor_section_handler() {
		AshtangaCore_Elementor_Section_Handler::get_instance();
	}

	add_action( 'init', 'ashtanga_core_init_elementor_section_handler', 1 );
}
