...
if ( ! function_exists( 'ashtanga_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function ashtanga_core_add_twitter_list_shortcode( $shortcodes ) {
		if ( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'AshtangaCore_Twitter_List_Shortcode';
		}

		return $shortcodes;
	}

	add_filter( 'ashtanga_core_filter_register_shortcodes', 'ashtanga_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'AshtangaCore_List_Shortcode' ) ) {
	class AshtangaCore_Twitter_List_Shortcode extends AshtangaCore_List_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( ASHTANGA_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'ashtanga_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'ashtanga-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'ashtanga-core' ) );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
			...
			$this->set_option(
				array(
					...
					'field_type' => 'text',
					'title'      => esc_html__( 'Number of Tweets', 'ashtanga-core' ),
					'group'      => esc_html__( 'Info', 'ashtanga-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Retweeted Text', 'ashtanga-core' ),
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Avatar Image', 'ashtanga-core' ),
					'options'       => ashtanga_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'ashtanga-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Author Name', 'ashtanga-core' ),
					'options'       => ashtanga_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'ashtanga-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Text', 'ashtanga-core' ),
					'options'       => ashtanga_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'ashtanga-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Media Placeholder', 'ashtanga-core' ),
			...
			$this->set_option(
				array(
					'name'          => 'show_date',
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Date', 'ashtanga-core' ),
					'options'       => ashtanga_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'ashtanga-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Actions', 'ashtanga-core' ),
					'options'       => ashtanga_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'ashtanga-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Twitter Link', 'ashtanga-core' ),
					'options'       => ashtanga_core_get_select_type_options_pool( 'no_yes' ),
					'default_value' => 'no',
					'group'         => esc_html__( 'Info', 'ashtanga-core' ),
				)
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'ashtanga_core_twitter_list', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return ashtanga_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
