...
if ( ! class_exists( 'AshtangaCore_Shortcodes' ) ) {
	class AshtangaCore_Shortcodes {
		...
		/**
		 * @return AshtangaCore_Shortcodes
		 */
		...
		function init() {
			...
			include_once ASHTANGA_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once ASHTANGA_CORE_SHORTCODES_PATH . '/class-ashtangacore-shortcode.php';
			include_once ASHTANGA_CORE_SHORTCODES_PATH . '/class-ashtangacore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'ashtanga_core_filter_register_shortcodes', array() );
	...
	AshtangaCore_Shortcodes::get_instance();
}
