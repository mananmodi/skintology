...
if ( ! function_exists( 'ashtanga_core_add_icon_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function ashtanga_core_add_icon_shortcode( $shortcodes ) {
		$shortcodes[] = 'AshtangaCore_Icon_Shortcode';

		return $shortcodes;
	}

	add_filter( 'ashtanga_core_filter_register_shortcodes', 'ashtanga_core_add_icon_shortcode', 8 );
}

if ( class_exists( 'AshtangaCore_Shortcode' ) ) {
	class AshtangaCore_Icon_Shortcode extends AshtangaCore_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( ASHTANGA_CORE_SHORTCODES_URL_PATH . '/icon' );
			$this->set_base( 'ashtanga_core_icon' );
			$this->set_name( esc_html__( 'Icon', 'ashtanga-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds icon element', 'ashtanga-core' ) );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
			...
			$this->set_option(
				array(
					'field_type' => 'iconpack',
					'name'       => 'main_icon',
					'title'      => esc_html__( 'Icon', 'ashtanga-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'options'    => array(
						...
						'tiny'    => esc_html__( 'Tiny', 'ashtanga-core' ),
						'small'   => esc_html__( 'Small', 'ashtanga-core' ),
						'medium'  => esc_html__( 'Medium', 'ashtanga-core' ),
						'large'   => esc_html__( 'Large', 'ashtanga-core' ),
						'huge'    => esc_html__( 'Huge', 'ashtanga-core' ),
					),
				)
			);
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_size',
					'title'      => esc_html__( 'Custom Size', 'ashtanga-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'options'       => array(
						'normal' => esc_html__( 'Normal', 'ashtanga-core' ),
			...
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'shape_size',
					'title'      => esc_html__( 'Shape Size', 'ashtanga-core' ),
					'group'      => esc_html__( 'Style', 'ashtanga-core' ),
					'dependency' => array(
						'show' => array(
							'icon_layout' => array(
			...
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'link',
					'title'      => esc_html__( 'Icon Link', 'ashtanga-core' ),
				)
			);
			$this->set_option(
				array(
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'ashtanga_core_icon', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return ashtanga_core_get_template_part( 'shortcodes/icon', 'templates/icon', '', $atts );
		}
