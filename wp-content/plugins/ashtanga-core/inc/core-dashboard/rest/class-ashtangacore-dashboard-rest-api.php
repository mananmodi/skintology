...
if ( ! class_exists( 'AshtangaCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class AshtangaCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'ashtanga_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return AshtangaCore_Dashboard_Rest_API
		 */
	...
	AshtangaCore_Dashboard_Rest_API::get_instance();
}
