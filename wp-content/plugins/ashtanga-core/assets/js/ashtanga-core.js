(function ( $ ) {
	...
	var qodefInlinePageStyle = {
		init: function () {
			this.holder = $( '#ashtanga-core-page-inline-style' );
	 ...
	 * Init offset appear
	 */
	var qodefOffsetAppear = {
		init: function () {
			var $items = $( '.qodef-offset-image-holder' );
	...
	qodefCore.qodefOffsetAppear = qodefOffsetAppear;
...
(function ( $ ) {
	...
	var qodefSpinner = {
		...
		init: function ( isEditMode ) {
			...
			if ( this.holder.length ) {
				if ( this.holder.hasClass( 'qodef-layout--ashtanga' ) ) {

					qodef.qodefWaitForImages.check(
						qodefSpinner.holder,
						function () {
							qodefSpinner.holder.addClass( 'qodef--start' );

							setTimeout(
								function () {
									var $appearedElements = $( '.qodef-image-with-text.qodef--appeared' );
									$appearedElements.removeClass( 'qodef--appeared' );
		...
		fadeOutLoader: function ( speed, delay, easing ) {
			...
			setTimeout(
				function () {
					qodefCore.shortcodes.ashtanga_core_image_with_text.qodefImageWithText.init();
				},
				speed
			);
...
(function ( $ ) {
						...
						$thisWishlistLink.off().on(
							...
							function ( e ) {
								...
								if ( qodefCore.body.hasClass( 'logged-in' ) ) {
									...
									// Trigger event.
									$( document.body ).trigger( 'ashtanga_membership_trigger_login_modal' );
								}
							}
						);
					}
			...
			$.ajax(
				{
					...
					success: function ( response ) {
						...
						if ( response.status === 'success' ) {
							...
							$( document ).trigger(
								'ashtanga_core_wishlist_item_is_updated',
	...
	$( document ).on(
		'ashtanga_core_wishlist_dropdown_item_is_removed',
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_accordion = {};
	...
	qodefCore.shortcodes.ashtanga_core_accordion.qodefAccordion = qodefAccordion;
...
(function ( $ ) {
	...
	$( document ).on(
		'ashtanga_core_trigger_author_load_more',
							...
							qodef.qodefWaitForImages.check(
								...
								function () {
									...
									qodefCore.body.trigger(
										'ashtanga_core_trigger_get_new_authors',
										[$holder]
									);
								}
							);
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_button = {};
	...
	qodefCore.shortcodes.ashtanga_core_button.qodefButton = qodefButton;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_countdown = {};
	...
	qodefCore.shortcodes.ashtanga_core_countdown.qodefCountdown = qodefCountdown;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_counter = {};
	...
	qodefCore.shortcodes.ashtanga_core_counter.qodefCounter = qodefCounter;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_custom_font = {};
	...
	var qodefCustomFont = {
		...
		initItem: function ( $holder ) {
			...
			if ( $holder.hasClass( 'qodef--has-appear' ) ) {
				qodefCore.qodefIsInViewport.check(
					$holder,
					function () {
						setTimeout(
			...
			if ( $holder.hasClass( 'qodef-custom-parallax' ) ) {
				gsap.registerPlugin( ScrollTrigger );

				var x = 200;

				if ( $holder.data( 'parallax' ) ) {
					x = $holder.data( 'parallax' );
				}

				if ( qodefCore.html.hasClass( 'touchevents' ) && $holder.data( 'parallax-touch' ) ) {
					x = $holder.data( 'parallax-touch' );
				}

				if ( $holder.hasClass( 'qodef-parallax-direction--right' ) ) {
					x = -x;
				}

				gsap.fromTo(
					$holder.find( '.qodef-custom-font-inner' ),
					{
						x: x,
					},
					{
	...
	qodefCore.shortcodes.ashtanga_core_custom_font.qodefCustomFont = qodefCustomFont;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_event_list                    = {};
	qodefCore.shortcodes.ashtanga_core_event_list.qodefSwiper        = qodef.qodefSwiper;
	qodefCore.shortcodes.ashtanga_core_event_list.qodefMasonryLayout = qodef.qodefMasonryLayout;
	qodefCore.shortcodes.ashtanga_core_event_list.qodefMagnificPopup = qodef.qodefMagnificPopup;
	qodefCore.shortcodes.ashtanga_core_event_list.qodefCustomCursor  = qodefCore.qodefCustomCursor;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_google_map = {};
	...
	qodefCore.shortcodes.ashtanga_core_google_map.qodefGoogleMap = qodefGoogleMap;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_icon = {};
	...
	qodefCore.shortcodes.ashtanga_core_icon.qodefIcon = qodefIcon;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_image_gallery                    = {};
	qodefCore.shortcodes.ashtanga_core_image_gallery.qodefSwiper        = qodef.qodefSwiper;
	qodefCore.shortcodes.ashtanga_core_image_gallery.qodefMasonryLayout = qodef.qodefMasonryLayout;
	qodefCore.shortcodes.ashtanga_core_image_gallery.qodefMagnificPopup = qodef.qodefMagnificPopup;
	qodefCore.shortcodes.ashtanga_core_image_gallery.qodefCustomCursor  = qodefCore.qodefCustomCursor;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_image_with_text = {};
	...
	var qodefImageWithText = {
		...
		initItem: function ( $currentItem ) {
			...
			var $link = $currentItem.find( '.qodef-m-image a, .qodef-m-title a' );
	...
	qodefCore.shortcodes.ashtanga_core_image_with_text.qodefImageWithText = qodefImageWithText;
	qodefCore.shortcodes.ashtanga_core_image_with_text.qodefMagnificPopup = qodef.qodefMagnificPopup;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_progress_bar = {};
	...
	qodefCore.shortcodes.ashtanga_core_progress_bar.qodefProgressBar = qodefProgressBar;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_single_image = {};
	...
	qodefCore.shortcodes.ashtanga_core_single_image.qodefSingleImage = qodefSingleImage;
...
(function ($) {
	...
	qodefCore.shortcodes.ashtanga_core_slider_showcase = {};
	qodefCore.shortcodes.ashtanga_core_slider_showcase.qodefSwiper = qodef.qodefSwiper;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_stacked_images = {};

	qodefCore.shortcodes.ashtanga_core_stacked_images.qodefAppear = qodefCore.qodefAppear;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_tabs = {};
	...
	qodefCore.shortcodes.ashtanga_core_tabs.qodefTabs = qodefTabs;
...
(function ($) {
	...
	qodefCore.shortcodes.ashtanga_core_text_marquee = {};
	...
	qodefCore.shortcodes.ashtanga_core_text_marquee.qodefTextMarquee = qodefTextMarquee;
...
(function ( $ ) {
	...
	var shortcode = 'ashtanga_core_textual_project_showcase';
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_video_button                    = {};
	qodefCore.shortcodes.ashtanga_core_video_button.qodefMagnificPopup = qodef.qodefMagnificPopup;
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_video_gallery                    = {};
	qodefCore.shortcodes.ashtanga_core_video_gallery.qodefSwiper        = qodef.qodefSwiper;
	qodefCore.shortcodes.ashtanga_core_video_gallery.qodefMasonryLayout = qodef.qodefMasonryLayout;
	qodefCore.shortcodes.ashtanga_core_video_gallery.qodefMagnificPopup = qodef.qodefMagnificPopup;
	qodefCore.shortcodes.ashtanga_core_video_gallery.qodefCustomCursor  = qodefCore.qodefCustomCursor;
...
(function ( $ ) {
	...
	var qodefStickySidebar = {
		init: function () {
			var info = $( '.widget_ashtanga_core_sticky_sidebar' );
...
(function ( $ ) {
	...
	var shortcode = 'ashtanga_core_blog_list';
	...
	$( document ).on(
		'ashtanga_trigger_get_new_posts',
		function () {
			qodefBlogList.init();
		}
	);
		...
		initHover: function ( $currentList ) {
			...
			if ( $items.length ) {
				$items.each(
					function () {
						var $item  = $( this );
						var $links = $item.find( '.qodef-e-media a, .qodef-e-title-link, .qodef-e-read-more a' );
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_instagram_list = {};
	...
	qodefCore.shortcodes.ashtanga_core_instagram_list.qodefInstagram = qodefInstagram;
	qodefCore.shortcodes.ashtanga_core_instagram_list.qodefSwiper    = qodef.qodefSwiper;
...
(function ($) {
	...
	var shortcode = 'ashtanga_core_timetable_events_list';
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_product_category_list                    = {};
	qodefCore.shortcodes.ashtanga_core_product_category_list.qodefMasonryLayout = qodef.qodefMasonryLayout;
	qodefCore.shortcodes.ashtanga_core_product_category_list.qodefSwiper        = qodef.qodefSwiper;
...
(function ( $ ) {
	...
	var shortcode = 'ashtanga_core_product_list';
...
(function ( $ ) {
	...
	qodefCore.shortcodes.ashtanga_core_clients_list             = {};
	qodefCore.shortcodes.ashtanga_core_clients_list.qodefSwiper = qodef.qodefSwiper;
...
(function ( $ ) {
	...
	var shortcode = 'ashtanga_core_team_list';
	...
	var qodefTeamList = {
		...
		initItem: function ( $currentHolder ) {
			if ( $currentHolder.hasClass( 'qodef-has-appear' ) ) {
				...
				var $items   = $currentHolder.find( '.qodef-e' );
				var $columns = $currentHolder.data( 'options' ).columns;
							...
							$items.each(
								function ( i ) {
									...
									qodefCore.qodefIsInViewport.check(
										$item,
										function () {
											var randomValues = [0, 200, 400, 600, 800, 1000, 1200, 1400];

											setTimeout(
												() => $item.addClass( 'qodef--appeared' ),
												randomValues[i % $columns]
											);
										}
									);
								}
	...
	qodefCore.shortcodes[shortcode].qodefTeamList = qodefTeamList;
})( jQuery );

(function ( $ ) {
	'use strict';

	qodefCore.shortcodes.ashtanga_core_testimonials_list = {};

	$( document ).ready(
		function () {
			qodefArrowLocation.init();
		}
	);

	var qodefArrowLocation = {
		init: function () {
			if ( qodef.qodefSwiper.swipers['testimonials'].length ) {
				qodef.qodefSwiper.swipers['testimonials'].forEach( function ( item ) {

					var currentSlider            = $( item.el ),
						currentSliderTopPosition = currentSlider.offset().top,
						arrows                   = currentSlider.find( '.swiper-button-prev, .swiper-button-next' ),
						locator                  = $( item.slides[item.activeIndex] ).find( '.qodef-arrow-location' ),
						locatorTopPosition       = currentSliderTopPosition,
						locatorHeight            = currentSlider.height();

					if ( locator.length ) {
						locatorTopPosition = locator.offset().top;
						locatorHeight      = locator.height();
					}

					arrows.css( { 'top': locatorTopPosition - currentSliderTopPosition + locatorHeight / 2 } );

					item.on(
						'activeIndexChange',
						function () {
							var currentItem               = $( item.slides[item.activeIndex] ),
								currentLocator            = currentItem.find( '.qodef-arrow-location' ),
								currentLocatorTopPosition = currentSliderTopPosition,
								currentLocatorHeight      = currentSlider.height();

							if ( currentLocator.length ) {
								currentLocatorTopPosition = currentLocator.offset().top;
								currentLocatorHeight      = currentLocator.height();
							}

							arrows.css( { 'top': currentLocatorTopPosition - currentSliderTopPosition + currentLocatorHeight / 2 } );
						}
					);
				} );
			}
	...
	qodefCore.shortcodes.ashtanga_core_testimonials_list.qodefArrowLocation = qodefArrowLocation;
	qodefCore.shortcodes.ashtanga_core_testimonials_list.qodefSwiper        = qodef.qodefSwiper;
