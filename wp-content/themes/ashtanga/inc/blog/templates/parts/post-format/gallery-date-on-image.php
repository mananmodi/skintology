...
if ( ! empty( $gallery_meta ) ) { ?>
	<div class="qodef-e-media-gallery qodef-swiper-container">
		...
		<div class="qodef-swiper-nav-holder">
			<div class="swiper-button-prev aaa"><?php ashtanga_render_svg_icon( 'pagination-arrow-left' ); ?></div>
			<div class="swiper-button-next"><?php ashtanga_render_svg_icon( 'pagination-arrow-right' ); ?></div>
		</div>
