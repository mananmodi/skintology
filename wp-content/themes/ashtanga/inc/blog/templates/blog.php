<div class="qodef-grid-item <?php echo esc_attr( ashtanga_get_page_content_sidebar_classes() ); ?>">
	...
	do_action( 'ashtanga_action_before_blog_loop' );
	?>
	<div class="qodef-blog qodef-m <?php echo esc_attr( ashtanga_get_blog_holder_classes() ); ?>">
		<?php
		// Include posts loop
		ashtanga_template_part( 'blog', 'templates/parts/loop' );
